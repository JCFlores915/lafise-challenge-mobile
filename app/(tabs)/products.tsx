  ...
  const products = [
    {
      ...
      details: "Intereses competitivos, sin comisiones.",
    },
    {
      id: "2",
      name: "Tarjeta de Crédito Oro",
      icon: "credit-card-outline",
      details: "Beneficios exclusivos y acumulación de puntos.",
    },
    {
      id: "3",
      name: "Préstamo Personal Rápido",
      icon: "cash-multiple",
      details: "Aprobación ágil para tus proyectos.",
    },
    {
      id: "4",
      name: "Seguro de Vida Protección Total",
      icon: "shield-account-outline",
      details: "Tranquilidad para ti y tu familia.",
    },
    {
      id: "5",
      name: "Inversiones Inteligentes",
      icon: "chart-line",
      details: "Haz crecer tu dinero con nuestros fondos.",
    },
  ];
